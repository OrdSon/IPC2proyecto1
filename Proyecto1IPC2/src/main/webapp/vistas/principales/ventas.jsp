<%-- 
    Document   : ventas.jsp
    Created on : 25/08/2021, 07:28:24 PM
    Author     : OrdSon
--%>
...
<html>
    ...
    <body style="margin: 0; padding: 0; height: 85vh; width: 100vw;">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="btn btn-info">
                            <a class="nav-link active text-white"  href="vistas/welcome/welcomeVentas.jsp" target="frameInterno">Inicio</a>
                        </li>
                        
                        <li class="btn btn-info">
                            <a class="nav-link active text-white" href="VentaServlet?accion=listar" target="frameInterno">Nueva venta</a>
                        </li>
                        ...
                        <li class="btn btn-info">
                            <a class="nav-link active text-white" href="VentaServlet?accion=listarRealizadas" target="frameInterno">Ver ventas realizadas</a>
                        </li>
                        <li class="btn btn-info">
                            <a class="nav-link active text-white" href="ClienteServlet?accion=listar" target="frameInterno">Agregar cliente</a>
                        </li>
                        <li class="btn btn-info">
                            <a class="nav-link active text-white" href="DevolucionServlet?accion=listar" target="frameInterno">Devoluciones</a>
                        </li>
                    </ul>
        ...
        <div class="m-4" style="height: 100%; width: 97%;">
            <iframe src="vistas/welcome/welcomeVentas.jsp" name="frameInterno" style="height: 100%; width: 100%;">
