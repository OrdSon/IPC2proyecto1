<%-- 
    ...
    Created on : 5/09/2021, 09:33:50 AM
    Author     : OrdSon
--%>
...
<html>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            ...
            <%
                Cliente clienteTemp = (Cliente) request.getAttribute("clienteDevolucionActivo");
                String nitCliente = "";
                ...
                if (clienteTemp != null) {
                    ...
                    request.setAttribute("codigoClienteDevolucionActivo", clienteTemp.getCodigo());
                }else{
            ...
            <div class="col-sm-6" style="position: relative; height: 500px;  overflow: auto; display: block;">
                <table class="table table-striped">
                    ...
                    <%
                        if (request.getAttribute("listaDevoluciones") != null) {
                            ArrayList<DetalleDevolucion> devoluciones = (ArrayList<DetalleDevolucion>) request.getAttribute("listaDevoluciones");
