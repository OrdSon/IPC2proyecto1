...
<html>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <%
                Cliente clienteTemp = (Cliente) request.getSession().getAttribute("clienteDiseñoActivo");
                ...
                if (clienteTemp != null) {
                    ...
                    codigoCliente = clienteTemp.getCodigo() + "";
                }
            %>
                ...
                <div class="card-body">
                    <form action="DesignServlet">
                        <div>
                            ...
                            <div >
                                <label>Modelo</label> 
                                <input type ="text" name = "txtModelo" class="form-control" value="<%=codigoCliente%>">      
            ...
            <div class="col-sm-6">
                ...
                <label class="h3">Productos en la compra</label>
